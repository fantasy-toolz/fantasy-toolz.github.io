document.addEventListener('DOMContentLoaded', () => {
    ...
    const csvUrl = 'https://raw.githubusercontent.com/fantasy-toolz/batting-order/refs/heads/main/data/Aggregate/2024-all-lineups.csv'; // Replace with your CSV URL
    let parsedData = [];
